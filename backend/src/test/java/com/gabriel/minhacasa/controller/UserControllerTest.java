...
class UserControllerTest {
    ...
    public static final BigDecimal BIG_DECIMAL = BigDecimal.valueOf(150000);
    ...
    void startElements() {
        ...
        this.immobile = new Immobile(
                ...
                GARAGE, QUANTITY_BEDROOMS, QUANTITY_ROOMS, IPTU, BIG_DECIMAL, SUITE, USEFUL_AREA, TOTAL_AREA, QUANTITY_BATHROOMS,
